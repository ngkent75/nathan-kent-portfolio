      ...
      <footer className='text-center text-white mt-5 bottomout'>
          <div className='container p-3 pb-0'>
              <section className='bg-dark mb-2'>
                 ...
                 <a href='https://github.com/ngkent75/nathan-kent-portfolio' target='_blank' rel="noreferrer" className='btn btn-outline-light btn-floating m-1' role='button' title='Github Repo'>< GoMarkGithub/> </a>
              </section>
